...
<body style="background: rgb(216, 216, 216)">
  @include('Header.header')
    ...
    <form class="container" style="padding: 50px" method="post" enctype="multipart/form-data" action="/Register">
        @csrf
        <div class="mb-3">
      ...
      @enderror
        <div class="mb-3">
            ...
            <input name="Date_of_Birth" type="date" class="form-control" id="exampleInputPassword1" placeholder="mm/dd/yyyy" value="{{old('Date_of_Birth')}}">
            @error('Date_of_Birth')
        <div class="asd" style="color: red">
          {{$message}}
        </div>   
